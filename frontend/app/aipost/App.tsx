          ...
          <div className="relative flex-1 flex flex-col overflow-hidden">
            ...
            {!showAssistant && (
              <button
                ...
                className="absolute top-16 right-4 z-30 flex items-center justify-center rounded-full bg-white p-3 text-gray-700 shadow-md border border-gray-200 hover:bg-gray-50 transition"
          ...
          >
            {showAssistant && (
              <div className="flex h-full flex-col">
                <div className="flex items-center justify-between border-b border-slate-200 px-3 py-2 bg-gray-50">
