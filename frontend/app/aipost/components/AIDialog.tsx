...
export default function AIDialog({
  ...
  const promptCards = suggestions.length > 0
    ? suggestions
    ...
    <div className="bg-white p-4 h-full">
      <div className="h-full flex flex-col max-w-4xl mx-auto">
            ...
            <div className="flex items-center gap-2">
              <div className="flex -space-x-2">
                {selectedElements.slice(0, 3).map((el, index) => (
                  <div
                    key={el.id}
                    className="w-8 h-8 rounded-full bg-gray-800 border-2 border-white flex items-center justify-center text-white text-xs"
        ...
        {isLoading && statusMessage && (
          <div className="mb-2 px-3 py-2 bg-gray-50 text-gray-700 rounded-lg text-sm flex items-center gap-2 animate-pulse border border-gray-200">
