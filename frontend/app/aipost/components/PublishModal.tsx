      ...
      <div className="w-[320px] rounded-2xl bg-white p-4 shadow-xl border border-slate-200">
        ...
        <div className="mt-4 flex justify-end gap-2">
          ...
          <button
            onClick={onConfirm}
            disabled={disabled}
            className="px-4 py-2 rounded-xl bg-gray-900 text-white hover:bg-gray-800 disabled:bg-slate-300 disabled:text-slate-600 disabled:cursor-not-allowed shadow"
          >
            Publish
          </button>
        </div>
