...
export default function Toolbar({
  ...
  const buttonBase =
    'flex items-center gap-2 px-3 py-2 rounded-xl text-sm font-medium transition-all border border-gray-200 bg-white text-gray-700 hover:bg-gray-50 active:scale-[0.99] shadow-sm';
  ...
  return (
    <>
      <div className="relative bg-white border-b border-gray-200 px-4 py-3 flex items-center gap-3 shadow-sm">
        <div className="flex items-center gap-2 rounded-full bg-gray-100 px-3 py-2 text-gray-900 font-semibold">
        ...
        <div className="flex items-center gap-2 pl-2">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={onUndo}
              disabled={!canUndo}
              className={`${buttonBase} disabled:opacity-50 disabled:cursor-not-allowed disabled:scale-100`}
              title="Undo"
            >
        ...
        <div className="ml-auto">
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 rounded-xl text-sm font-medium transition-all border border-transparent bg-gray-900 text-white hover:bg-gray-800 active:scale-[0.99] shadow-md disabled:bg-gray-300 disabled:text-gray-500 disabled:cursor-not-allowed"
          >
